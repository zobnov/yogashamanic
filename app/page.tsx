...
const wheelSegments = [
  {
    ...
    text: "Скинути стару шкіру, вогонь, активність, інтенсивний рух до цілі.",
  },
  {
    direction: "Захід",
    symbol: "Ягуар",
    ...
    text: "Тіні, зв'язки з домом і родом, прохід через темряву, вихід у майстерність",
  },
  {
    direction: "Північ",
    symbol: "Колібрі",
    ...
    text: "Поклик Духа до великої подорожі, сакральна пауза",
  },
  {
    direction: "Схід",
    symbol: "Орел",
...
const traditions = [
  "Ми звернемося і до інших традицій.",
  "Шаманське колесо Північної Америки, як щоденна опора.",
  "Слов'янський коловорот як зв'язок з пам'яттю предків.",
  "Вікканське колесо як доторк до кельтської традиції енергетичної циклічності року.",
  "Ми відчуємо єдність і нюанси відмінностей духовних систем різних культур, що прийшли з різних континентів.",
  "Ми будемо встановлювати цілі на кожний сектор Колеса і спостерігати як ми наближаємося до них",
];

const belovedPractices = [
  "Йога та Йога Денс",
  "Медитації",
  "Архетипи Великої Богині",
  "Тварини сили",
  "Цикли Місяця",
  "Спостереження за природою і звичайним життям",
  "Вміння читати послання Духа через серединний світ",
];
...
const audience = [
  "Для тих, хто втомився від занадто великої кількості духовних вчителів і голосів з усіх сторін і сторінок і хоче відокремити найважливіше для себе, налаштувати внутрішній компас.",
  "Для тих, хто досліджує час, відчуває, що він може текти по-різному.",
  "Хто хоче пізнати себе і рухатися до цілей органічно відповідно до енергій року і власної природи.",
  "Хто хоче знайти свій власний унікальний красивий ритм.",
  "Для тих, хто хоче більше присутності у власному тілі.",
  "Для тих, хто шукає духовну та фізичну практику, що не відриває від життя, а допомагає проживати його глибше.",
  "Для практиків йоги, психологів, дослідників символів, архетипів і шаманських традицій.",
  "І для всіх, кого кличе шлях Кола.",
];
...
const faqs = [
  ...
  {
    question: "На що спирається річна подорож?",
    answer: "Ми будемо спиратися на колесо медицини Південної Америки, яке досліджував Альберто Виллолдо.",
  },
  {
    question: "Що відбувається на Молодик та Повню?",
    answer: "Зустрічі і група На рівних з Вогняною церемонією у фіналі, Карта Оракулу чи Таро. Три дні до повні, день повні, три дні після повні - медитуємо з мантрами.",
  },
  {
    question: "Де будуть матеріали програми та де проходять зустрічі?",
    answer: "Основна інформація та матеріали будуть у Telegram-каналі. Онлайн-зустрічі проходитимуть у Zoom. Частина інформації для курсу буде надана у форматі відеозаписів.",
  },
  {
    question: "Які є варіанти участі?",
    answer: "Літній сектор на 3 місяці, Літо + Осінь на 6 місяців або Повне Коло Року.",
  },
];
    ...
    <main className="overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 text-base leading-8 text-[#59564b]">
              ...
              подорож Шаманським Колесом.
            </p>
            <p className="mt-4 text-base leading-8 text-[#59564b]">
              Це можливість прожити цикли у відповідності з сегментами колеса
              через власний досвід і тіло.
            </p>
            <p className="mt-4 text-base leading-8 text-[#59564b]">
              Ми будемо спиратися на колесо медицини Південної Америки, яке
              досліджував Альберто Виллолдо.
            </p>
          </div>
      ...
      <section className="bg-[#f4ebdc] px-5 py-16 sm:px-8 sm:py-24 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_1fr]">
          <div>
            <p className="section-kicker">Традиції</p>
            <h2 className="mt-3 text-3xl font-semibold leading-tight text-[#2f3128] sm:text-4xl">
              Єдність і нюанси різних духовних систем
            </h2>
            <div className="mt-6 space-y-4 text-base leading-8 text-[#59564b]">
              {traditions.map((item) => (
                <p key={item}>{item}</p>
              ))}
            </div>
          ...
          <div>
            <p className="section-kicker">Буде все, що ми любимо</p>
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {belovedPractices.map((item) => (
                <div
                  className="rounded-[8px] border border-[#dfd2be] bg-[#fbf8f0] p-4 text-[#424237]"
                  key={item}
                >
                  {item}
                </div>
